...
function ProvidersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="font-display text-lg font-bold">Canales WhatsApp / SMS</h3>
        <p className="mt-1 text-sm text-muted-foreground">
          Estos son canales{" "}
          <strong className="text-foreground">adicionales</strong>: pueden estar
          conectados en paralelo a tu proveedor de email. Sus audiencias son tus
          listas locales de contactos con teléfono.
        </p>
          ...
          {connections.isLoading ? (
            ...
            <>
              ...
              <WhatsAppProviderCard
                tenantId={tenantId}
                connection={connectionFor("whatsapp")}
              />
            </>
          )}
        </div>
