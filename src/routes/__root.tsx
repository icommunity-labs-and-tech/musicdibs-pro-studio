...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "¿Y si tus clientes pudieran escuchar tu marca? Convierte tus campañas de email y WhatsApp en experiencias sonoras que aumentan apertura, engagement y conversión" },
      { property: "og:description", content: "¿Y si tus clientes pudieran escuchar tu marca? Convierte tus campañas de email y WhatsApp en experiencias sonoras que aumentan apertura, engagement y conversión" },
      { name: "twitter:description", content: "¿Y si tus clientes pudieran escuchar tu marca? Convierte tus campañas de email y WhatsApp en experiencias sonoras que aumentan apertura, engagement y conversión" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600;9..144,700&family=Syne:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
